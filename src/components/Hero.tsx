        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-14">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              I'm Neema Kemunto
              <span className="block text-xl sm:text-2xl md:text-3xl font-normal mt-3 text-primary-gray dark:text-dark-text">
            ...
            <motion.p 
              ...
              className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-teal dark:text-dark-teal mb-5"
            >
            ...
            >
              ...
              and make informed decisions through data analysis. With expertise spanning business intelligence, 
              strategic planning, and systems management, I deliver solutions that create measurable impact.
            </motion.p>
          ...
          >
            <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-[420px] lg:h-[420px] xl:w-[480px] xl:h-[480px]">
              <div className="absolute inset-0 bg-gradient-to-br from-primary-teal to-primary-navy rounded-full opacity-10 blur-3xl scale-110"></div>
              <Image
